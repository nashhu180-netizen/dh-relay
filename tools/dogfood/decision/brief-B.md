...
2. 写交接文件 `$env:RELAY_ATTEMPT_DIR/handoff-body.md`（B.txt 在哪、第一行是什么）。
3. 交棒：`pwsh -NoProfile -File $env:RELAY_TOOL result -Status succeeded -Summary "B.txt written" -NextAction none -HandoffBody $env:RELAY_ATTEMPT_DIR/handoff-body.md`
