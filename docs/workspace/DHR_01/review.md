...
| 验什么 | 做什么 | 通过标准 | 结果 |
|--------|--------|----------|------|
| 机器证全绿 + 两轮复核收敛（E10 证据展示） | 查看 AI 在对话展示的 `run-relay-tests.ps1` 输出、探针记录与两轮复核结论 | RELAY ALL PASS + 0 open P0/P1 + 轮1/轮2 均已落账 | [ ] 待用户 E11 一次性确认本地收口授权包 |
...
|---------|--------|----------------------|----------------------|-------------------------------|---------------|--------------------------------|
| （待 E11） | hyf | releasePacket-DHR_01 | shown-v1 | E-012 亲跑 + 三轮复核落账 | DHR01-A1/A2/A4/A5/A8 | （待） |
