...
- [Herdr host_ref 正式冻结与 DSH-off 可验证展示](./14-Herdr-host-ref正式冻结与DSH-off可验证展示.md)
...
- [A-29 Herdr host_ref 正式冻结与 DSH-off 可验证展示（正式设计输入）](./14-Herdr-host-ref正式冻结与DSH-off可验证展示.md)
