...
进行到: P5 ▸ **DHR_29 Store / 事件账 / 确定性回放 + 契约修订批次 1 施工中**（任务树 `wt/DHR_29`，基于 `master@c44d392`）；DHR_51 / DHR_52 保持未开始。
下一步: 完成 DHR_29 第一批 TDD：Store 纯库、追加事件账、确定性回放与 K-1 事件产生者；不得触及 DHR_51 宿主/lease 或 DHR_52 RPC。
...
| DHR_29 | 实现唯一写者 Store、追加事件账与确定性回放；顺带做契约修订批次 1 | 标准 · **高危** | 进行中 | DHR_28 | [workspace/DHR_29/](../workspace/DHR_29/) | | `DHR-B-15` 保 ID 缩范围（原含宿主与 RPC，已拆出 DHR_51 / DHR_52）。任务树=`wt/DHR_29`，用户 2026-08-21 对话授权施工至 E10；K-1 裁决为本批新增事件产生者。**高危系主会话判断**：本卡动已冻结契约与三份基线，后果等价于宪章#2 的「数据口径」（改一个字即断握手），宪章五类里无「契约修订」一项 |
