...
<!-- dh:plan-type: 开发 -->
<!-- dh:planning-event:v1 id=DHR-B-17 stage=B-adjust artifact=dev_plan/P5-Relay-v2持久内核与DSH桥接-开发方案.md review=../design/evidence/09-P4至P9阶段计划-交叉审核记录.md#review-b17 understanding=../design/evidence/09-P4至P9阶段计划-交叉审核记录.md#understanding-b17 -->
<!-- dh:status
...
现状: **P4 阶段闸已解锁**——CM1/2/3/5/6a 全绿 + 主报告落盘（P4 verify `252a131`）+ 用户 2026-08-20 对话放行；**DHR_28、DHR_29、DHR_51、DHR_52 已完成**——relay v2 最小协议集已冻结，`relay-core/` 是本仓唯一契约来源；DHR_30 / DHR_31 未开始。
进行到: P5 ▸ DHR_52 已于 2026-08-23 经用户本地收口授权包放行并 verify；DHR_30 / DHR_31 未开始。
下一步: **DHR_30 开工前分流**（Relay CLI 参考客户端与可选 DSH/Pi Bridge 接缝）；不在本授权包内。
