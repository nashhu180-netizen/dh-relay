...
<!-- dh:planning-event:v1 id=DHR-B-36 stage=B-adjust artifact=dev_plan/P6-Herdr多账号执行底座-开发方案.md review=../design/evidence/36-DHR71隔离清单与绿闸范围校正-B调整交叉审核记录.md#review-b36 understanding=../design/evidence/36-DHR71隔离清单与绿闸范围校正-B调整交叉审核记录.md#understanding-b36 -->
