...
| [P6-Herdr多账号执行底座](./P6-Herdr多账号执行底座-开发方案.md) | 接入多账号 Codex/Claude Code，验证 DSH-off 和 Linux SSH Herdr 路径 | 已解锁（2026-08-29）；DHR_32/33/34/61/63/64/65/66/67/68 已完成并 verify；`DHR-B-33`（2026-08-31 已确认）新增 DHR_69（未开始，A-27 硬前置）；DHR_35 进行中，blocked-by:DHR_69 | DHR_32~35、DHR_61、DHR_63~69 |
