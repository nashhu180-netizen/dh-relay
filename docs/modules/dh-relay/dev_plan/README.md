...
| [P6-Herdr多账号执行底座](./P6-Herdr多账号执行底座-开发方案.md) | 接入多账号 Codex/Claude Code，验证 DSH-off 和 Linux SSH Herdr 路径 | 已解锁（2026-08-29）；DHR_32/33/34/61/63~71/76 已完成；DHR_74 待验收；DHR_75 进行中且其 blocked-by:DHR_76 已解除，尚待独立rebase与复验；DHR_72 进行中且 blocked-by:DHR_75；DHR_35 进行中且 blocked-by:DHR_72；DHR_73 未开始 | DHR_32~35、DHR_61、DHR_63~76（DHR_62 不属任务卡；DHR_74~76 单列） |
