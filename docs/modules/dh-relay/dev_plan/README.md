...
| [P6-Herdr多账号执行底座](./P6-Herdr多账号执行底座-开发方案.md) | 接入多账号 Codex/Claude Code，验证 DSH-off 和 Linux SSH Herdr 路径 | 已解锁（2026-08-29）；`DHR-B-22` B-调整（Linux/SSH 项按用户指示延后、审计范围主控代决策冻结）；DHR_32 开工 | DHR_32~35 |
