...
| [P6-Herdr多账号执行底座](./P6-Herdr多账号执行底座-开发方案.md) | 接入多账号 Codex/Claude Code，验证 DSH-off 和 Linux SSH Herdr 路径 | 已解锁（2026-08-29）；`DHR-B-22` B-调整（待用户追认）；DHR_32 待人验（squash `2667f4a` 委托代合入）；DHR_33~35 未开始 | DHR_32~35 |
