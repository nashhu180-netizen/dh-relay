...
| [P6-Herdr多账号执行底座](./P6-Herdr多账号执行底座-开发方案.md) | 接入多账号 Codex/Claude Code，验证 DSH-off 和 Linux SSH Herdr 路径 | 已解锁（2026-08-29）；DHR_32/33/34/61/63~72/74~77 已完成；DHR_73、DHR_78 未开始；DHR_35 进行中且 blocked-by:DHR_78，之后仍须独立 D-start | DHR_32~35、DHR_61、DHR_63~78（DHR_62 不属任务卡） |
