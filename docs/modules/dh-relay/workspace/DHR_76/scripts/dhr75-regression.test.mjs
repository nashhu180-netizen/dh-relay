...
import { HERDR_START_TIMEOUT_MS, makeHerdrCli } from '../../../../../../relay-core/runtime/executors/herdr/herdr-cli.mjs';
import { createHostSessionActor, runHostSession } from '../../../../../../relay-core/runtime/host.mjs';
import { acquireLease, readLease } from '../../../../../../relay-core/runtime/lease.mjs';
import { isProcessAlive } from '../../../../../../relay-core/runtime/pidalive.mjs';
import { createRunWithNumbering } from '../../../../../../relay-core/runtime/startrun.mjs';
import { startWorkflowDriver } from '../../../../../../relay-core/runtime/workflow-driver.mjs';
...
test('DHR_75/A：真实慢 Herdr 子进程不阻塞同一事件循环的续租节拍', async (t) => {
  ...
  const hostSource = await readFile(new URL('../../../../../../relay-core/runtime/host.mjs', import.meta.url), 'utf8');
  ...
  const bin = fileURLToPath(new URL('./dhr75-helper.mjs', import.meta.url));
