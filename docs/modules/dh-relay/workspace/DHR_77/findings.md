...
| F-7709 | P3 / scope-observed | E12 合入复验的 DHR_69/75 兄弟组合首次 16/17：DHR_75/B 在 actor close 后的异步清理读取空 lease；同一主干随后的 DHR_75 单文件 7/7 与原双文件组合 17/17 均自然终态通过。该形态与本卡改动前 E-7714 已见的 DHR_75/B lease 时序/测试清理空值同类，且不触及 DHR_77 核心 113/113。 | E-7751（首次失败）；E-7752（两次最窄复现均绿）；E-7753/E-7754（仓根回归与 dh 通过）。 | 作为 DHR_75 既有非确定性测试债务保留，不在 DHR_77 越界修复；DHR_77 的 B-45 夹具输入兼容已由原组合 17/17 复验。完整 npm 仍按 E-7721 记“未得终态”。 | open outside DHR_77 |
