...
| F-226 | P1 | `verify(dh-relay)` 的强制提交钩子要求完整 `dh dh-relay` 零失败；E-080 实测仍有 34 条历史失败（design 输入结构、DHR_03/29/49/51），因此拒绝产生 verify 提交。 | E-080；E-081；提交钩子完整输出 | 用户已授权治理修复；squash `89c0d5d` 后 `dh dh-relay` 为 0 failure，且主干全量复验通过。 | resolved |
