...
Worktree `/home/nash/work/dh-relay/.dh-worktrees/RLT_27`, baseline d954428. All relay_log calls explicitly use absolute config-dir `/home/nash/work/dh-relay/.dh-worktrees/RLT_27/docs/modules/relay-light/workspace/RLT_27/config` and plan-dir `/home/nash/work/dh-relay/.dh-worktrees/RLT_27/docs/modules/relay-light/relay/rlt27-linux-codex-01`.
...
|---|---|---|---|---|---|---|
| builder | W1 | builder | | workspace/RLT_27/evidence/builder.md | | Inspect prebuilt seven files; write observation only |
| plan-reviewer | W1 | plan-reviewer | | workspace/RLT_27/review.plan.md | on:review_ready:builder | PASS before done; fail checkpoint to same builder |
| coder | C1 | coder | | workspace/RLT_27/linux-codex-usage.md | | Write real usage guide and findings/lesson if needed |
| checker | C1 | checker | | workspace/RLT_27/check.C1.md | | Concurrent role; await coder ready signal before judgement |
| scribe | C1 | scribe | | workspace/RLT_27/progress.md | on:done:coder | Wait checker PASS also; append facts only |
| lesson | R1 | reviewer | | workspace/RLT_27/review.lesson.md | | Independent fresh instance; only own review |
| consistency | R1 | reviewer | | workspace/RLT_27/review.consistency.md | | Independent fresh instance; only own review |
| scribe | R1 | scribe | | workspace/RLT_27/review.md | | Launch only after both reviewers done; append summary/progress |
| scribe | F1 | scribe | | workspace/RLT_27/evidence/handoff.md | | Write status/lint evidence and user-facing handoff/progress |
