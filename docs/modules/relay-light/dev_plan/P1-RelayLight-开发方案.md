...
| RLT_23 | 回流派活纪律与收口 checklist（通知投递/启动档位/agent_lost/删树） | 轻 | 未开始 | 6 | RLT-A-11 | — | — | 承接 RLT_11 F-003/F-005/F-006/F-007（用户 2026-09-16 裁决）；Issue #38；验收 ID `HC-RL-A151`～`A154`（RLT-A-11 已续发，PR #41） |
