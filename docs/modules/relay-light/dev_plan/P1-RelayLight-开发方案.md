...
现状: RLT_01/07/08/10/09 均已合入；RLT_12 真计划 `rlt12-win-01` 五阶段（W/C/R/X/F）已全闭合，RLT_21 在同一真计划内完成八笔提交、单测 181 全绿，**两卡均未 verify、未验收、未合并**；RLT_12 的 C1 节点暴露「复核打回后节点内无合法返工路径」（findings F-008），经 RLT-A-09 裁决另起 RLT_22 承接
